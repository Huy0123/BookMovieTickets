...
router.post('/callbackZalopay',autUser,PaymentController.callbackZalopay)
router.post('/createrVnpay',autUser,PaymentController.createrVnpay)
router.get('/vnpay-return/:query',autUser,PaymentController.returnVnpay)
router.post('/callback',autUser,PaymentController.callback)
