const images= {
    banner1: require('~/assets/img/joker-folie-a-deux-2024-movie-dl-1920x1080.jpg'),
    banner2: require('~/assets/img/TF1_DOM_Online_Payoff_1-Sheet_05_FIN5_1-1-2000x1125.jpg'),
